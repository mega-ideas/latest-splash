...
const dashboardMeta: Array<[string, ContextMeta]> = [
  ...
  ['/dashboard/treasury', { eyebrow: 'Smart treasury', title: 'Keep operating cash productive', copy: 'Manage liquidity and settlement availability from one view; treasury posture stays projected and approval-gated.', icon: '/isometric/stats-icon.svg', signal: 'Projection only' }],
