        ...
        <div className="flex flex-wrap items-end gap-2">
          <div>
            ...
            <input
              ...
              className="mt-1 block w-40 rounded-lg border border-[#326273]/25 bg-[#F6F0ED] px-3 py-2 font-mono text-lg tracking-[0.3em] text-[#1F4452] focus:border-[#5C9EAD] focus:outline-none focus:ring-2 focus:ring-[#5C9EAD]/30"
            />
          </div>
