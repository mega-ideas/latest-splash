...
import { Activity, ClipboardCheck, Headphones, KeyRound, LayoutDashboard, ListChecks, Settings2, UserRoundCheck } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Go-live', href: '/admin/go-live', icon: ListChecks },
