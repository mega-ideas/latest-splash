...
const legacyHexAllowances = {
  ...
  'components/FloatingCopilot.tsx': ['#0c3e48', '#0d6370', '#326273', '#9a4a2d', '#cfe8e0', '#e39774', '#eaf6f1', '#efc46f', '#f4efe4', '#fffdf9'],
  ...
  'components/SettlementProofDrawer.tsx': ['#326273', '#9a4a2d', '#e39774', '#f6f0ed'],
  ...
  'components/dashboard/DashboardShell.tsx': ['#1f4452', '#326273', '#e39774'],
