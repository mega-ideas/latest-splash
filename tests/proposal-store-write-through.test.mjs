...
test('an approval that did not reach Postgres moves no money', async () => {
  ...
  const outcome = await withProposalWritesFailing(() => settleFullyApprovedProposal('prop_outage'));
